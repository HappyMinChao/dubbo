...
public class DemoServiceImpl3 implements DemoService3 {
    private static final Logger logger = LoggerFactory.getLogger(DemoServiceImpl3.class);

    @Override
    public String sayHello3(String name) {
        logger.info("Hello3 " + name + ", request from consumer: "
                + RpcContext.getServiceContext().getRemoteAddress());
        return "Hello3 " + name + ", response from provider: "
